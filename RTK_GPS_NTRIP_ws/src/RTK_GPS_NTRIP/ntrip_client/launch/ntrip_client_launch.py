...
'''
EMLID CASTOR
          DeclareLaunchArgument('host',                  default_value='caster.emlid.com'),
          DeclareLaunchArgument('port',                  default_value='2101'),
          DeclareLaunchArgument('mountpoint',            default_value='MP20065'), 
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='u53355'),
          DeclareLaunchArgument('password',              default_value='997pzq'),

SIRENT FREE TRIAL
 	  DeclareLaunchArgument('host',                  default_value='199.184.151.36'),
          DeclareLaunchArgument('port',                  default_value='2101'),
          DeclareLaunchArgument('mountpoint',            default_value='RTK_SNUS_32'), 
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='FGRVRT01'),
          DeclareLaunchArgument('password',              default_value='HIIVQS8YID0R'), 
          
YJ'S PHONE (MOWBRAY):
 	  DeclareLaunchArgument('host',                  default_value='192.168.116.24'),
          DeclareLaunchArgument('port',                  default_value='2101'),
          DeclareLaunchArgument('mountpoint',            default_value='SGP_NUS'), 
          DeclareLaunchArgument('ntrip_version',         default_value='None'),
          DeclareLaunchArgument('authenticate',          default_value='True'),
          DeclareLaunchArgument('username',              default_value='user'),
          DeclareLaunchArgument('password',              default_value='pw'),         
'''
