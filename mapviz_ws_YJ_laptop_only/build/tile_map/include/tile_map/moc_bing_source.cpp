...
void tile_map::BingSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BingSource *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject tile_map::BingSource::staticMetaObject = { {
    QMetaObject::SuperData::link<TileSource::staticMetaObject>(),
    qt_meta_stringdata_tile_map__BingSource.data,
    qt_meta_data_tile_map__BingSource,
    qt_static_metacall,
    nullptr,
    nullptr
} };
