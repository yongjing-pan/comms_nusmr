...
void tile_map::TileSource::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TileSource::*)(const std::string & ) const;
...
QT_INIT_METAOBJECT const QMetaObject tile_map::TileSource::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_tile_map__TileSource.data,
    qt_meta_data_tile_map__TileSource,
    qt_static_metacall,
    nullptr,
    nullptr
} };
