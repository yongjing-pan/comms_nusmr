...
void tile_map::TileMapPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TileMapPlugin *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject tile_map::TileMapPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<mapviz::MapvizPlugin::staticMetaObject>(),
    qt_meta_stringdata_tile_map__TileMapPlugin.data,
    qt_meta_data_tile_map__TileMapPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
