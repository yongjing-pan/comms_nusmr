...
public:
    ...
    void setupUi(QWidget *configitem)
    {
        ...
        header->setStyleSheet(QString::fromUtf8("QWidget { background-color : DarkGray ;}"));
        ...
        signlabel->setStyleSheet(QString::fromUtf8("QLabel { background-color : LightGray ; }"));
    ...
    void retranslateUi(QWidget *configitem)
    {
        ...
        signlabel->setText(QCoreApplication::translate("configitem", " - ", nullptr));
        namelabel->setText(QCoreApplication::translate("configitem", "Name", nullptr));
        show->setText(QString());
        label->setText(QCoreApplication::translate("configitem", "Config goes here...", nullptr));
    } // retranslateUi
