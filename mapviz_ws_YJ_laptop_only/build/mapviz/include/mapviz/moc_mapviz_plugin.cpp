...
void mapviz::MapvizPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MapvizPlugin *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (MapvizPlugin::*)(int );
        ...
        {
            using _t = void (MapvizPlugin::*)(const std::string & );
        ...
        {
            using _t = void (MapvizPlugin::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject mapviz::MapvizPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_mapviz__MapvizPlugin.data,
    qt_meta_data_mapviz__MapvizPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
