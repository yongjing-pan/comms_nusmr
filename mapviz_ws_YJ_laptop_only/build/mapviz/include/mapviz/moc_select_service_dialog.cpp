...
void mapviz::ServiceUpdaterThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ServiceUpdaterThread *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ServiceUpdaterThread::*)(ServiceStringVector );
        ...
        {
            using _t = void (ServiceUpdaterThread::*)(const QString );
...
QT_INIT_METAOBJECT const QMetaObject mapviz::ServiceUpdaterThread::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_mapviz__ServiceUpdaterThread.data,
    qt_meta_data_mapviz__ServiceUpdaterThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SelectServiceDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mapviz::SelectServiceDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_mapviz__SelectServiceDialog.data,
    qt_meta_data_mapviz__SelectServiceDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
