...
void mapviz::ConfigItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ConfigItem *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (ConfigItem::*)(QListWidgetItem * , bool );
        ...
        {
            using _t = void (ConfigItem::*)(QListWidgetItem * );
...
QT_INIT_METAOBJECT const QMetaObject mapviz::ConfigItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_mapviz__ConfigItem.data,
    qt_meta_data_mapviz__ConfigItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
