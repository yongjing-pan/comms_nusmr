...
void mapviz_plugins::MarkerPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MarkerPlugin *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mapviz_plugins::MarkerPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<mapviz::MapvizPlugin::staticMetaObject>(),
    qt_meta_stringdata_mapviz_plugins__MarkerPlugin.data,
    qt_meta_data_mapviz_plugins__MarkerPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
