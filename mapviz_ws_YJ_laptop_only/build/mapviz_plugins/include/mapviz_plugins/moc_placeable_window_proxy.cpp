...
void mapviz_plugins::PlaceableWindowProxy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PlaceableWindowProxy *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (PlaceableWindowProxy::*)(const QRect & );
...
QT_INIT_METAOBJECT const QMetaObject mapviz_plugins::PlaceableWindowProxy::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_mapviz_plugins__PlaceableWindowProxy.data,
    qt_meta_data_mapviz_plugins__PlaceableWindowProxy,
    qt_static_metacall,
    nullptr,
    nullptr
} };
