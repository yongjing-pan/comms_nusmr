...
void mapviz_plugins::MeasuringPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MeasuringPlugin *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mapviz_plugins::MeasuringPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<mapviz::MapvizPlugin::staticMetaObject>(),
    qt_meta_stringdata_mapviz_plugins__MeasuringPlugin.data,
    qt_meta_data_mapviz_plugins__MeasuringPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
