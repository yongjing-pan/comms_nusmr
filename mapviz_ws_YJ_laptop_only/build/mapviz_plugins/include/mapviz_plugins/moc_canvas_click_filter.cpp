...
void mapviz_plugins::CanvasClickFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CanvasClickFilter *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (CanvasClickFilter::*)(const QPointF & );
...
QT_INIT_METAOBJECT const QMetaObject mapviz_plugins::CanvasClickFilter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_mapviz_plugins__CanvasClickFilter.data,
    qt_meta_data_mapviz_plugins__CanvasClickFilter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
