...
void mapviz_plugins::PointCloud2Plugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PointCloud2Plugin *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mapviz_plugins::PointCloud2Plugin::staticMetaObject = { {
    QMetaObject::SuperData::link<mapviz::MapvizPlugin::staticMetaObject>(),
    qt_meta_stringdata_mapviz_plugins__PointCloud2Plugin.data,
    qt_meta_data_mapviz_plugins__PointCloud2Plugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
