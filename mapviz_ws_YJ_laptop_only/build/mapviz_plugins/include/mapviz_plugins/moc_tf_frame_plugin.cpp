...
void mapviz_plugins::TfFramePlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TfFramePlugin *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject mapviz_plugins::TfFramePlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<mapviz_plugins::PointDrawingPlugin::staticMetaObject>(),
    qt_meta_stringdata_mapviz_plugins__TfFramePlugin.data,
    qt_meta_data_mapviz_plugins__TfFramePlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
