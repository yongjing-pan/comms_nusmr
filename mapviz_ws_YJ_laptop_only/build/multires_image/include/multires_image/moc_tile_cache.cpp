...
void multires_image::TileCache::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TileCache *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (TileCache::*)(int64_t );
...
QT_INIT_METAOBJECT const QMetaObject multires_image::TileCache::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_multires_image__TileCache.data,
    qt_meta_data_multires_image__TileCache,
    qt_static_metacall,
    nullptr,
    nullptr
} };
